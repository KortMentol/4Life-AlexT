      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-6">
              Я не являюсь врачом, и продукция 4Life не заменяет медикаментозное лечение. Моя задача – предоставить Вам
              исчерпывающую информацию, основанную на официальных данных компании и научных исследованиях, помочь
              разобраться в ассортименте и подобрать оптимальные решения для поддержки Вашего организма.
            </p>
