...
const HomePage: React.FC = () => {
  ...
  const heroContentY = useTransform(heroScroll, [0, 1], shouldAnimate ? ["0%", "18%"] : ["0%", "0%"]);
  const heroContentOpacity = useTransform(heroScroll, [0, 0.65], shouldAnimate ? [1, 0] : [1, 1]);
