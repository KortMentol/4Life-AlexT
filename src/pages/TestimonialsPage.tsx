...
const testimonials = [
  ...
  },
  {
    ...
    quote: "Как человек, ведущий активный образ жизни и занимающийся спортом, я искал качественную поддержку для своего организма. 4Life Transfer Factor Plus стал для меня настоящим открытием. Он помогает мне быстрее восстанавливаться после тренировок и поддерживать высокий уровень работоспособности. Отличный продукт!"
  },
  {
  ...
  },
  {
    ...
    quote: "Для меня как для человека, часто контактирующего с большим количеством людей, поддержка иммунитета крайне важна. Начал принимать 4Life Transfer Factor Tri-Factor Formula по совету Александра и отметил, что стал намного реже подхватывать сезонные вирусы. Буду продолжать прием и дальше!"
  },
  {
  ...
  },
  {
    ...
    quote: "Как спортсмен, я всегда ищу натуральные способы поддержки организма. 4Life Transfer Factor Plus стал отличным дополнением к моему режиму. После интенсивных тренировок восстанавливаюсь быстрее, и энергия держится весь день."
  },
  {
    ...
    quote: "RioVida Stix – это настоящая находка для моей активной жизни! Удобно брать с собой в командировки, вкус приятный. Особенно заметила улучшение сна и общего самочувствия. Рекомендую всем, кто ведет активный образ жизни!"
  },
  {
    ...
    quote: "Благодарю Александра за рекомендацию 4Life Transfer Factor Classic. После месяца приема почувствовал значительное улучшение общего самочувствия. Особенно рад, что продукт помогает поддерживать здоровье без искусственных стимуляторов."
  }
];
