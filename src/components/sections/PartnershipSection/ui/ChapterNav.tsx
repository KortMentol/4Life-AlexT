...
const ChapterNav = memo(({ active, tier, palette, visible, chapterRefs }: ChapterNavProps) => {
                    ...
                    <motion.div
                      variants={{
                        rest: {
                          ...
                          backgroundColor: isActive ? palette.gold : palette.overlay20,
                        },
                        hover: {
                          height: isActive ? 28 : 10,
                          backgroundColor: isActive ? palette.gold : palette.overlay40,
                        },
                      }}
