    ...
    <section ref={sectionRef} className="relative min-h-[300vh] overflow-hidden bg-transparent">
      ...
      <div className="relative z-30 px-4 py-24 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <h3 className="mb-8 text-4xl font-semibold text-gray-900 dark:text-white md:text-6xl">Бизнес с 4Life</h3>
          <ScrollText className="mx-auto max-w-4xl text-lg leading-relaxed">
            Присоединяйтесь к глобальному сообществу предпринимателей, которые строят успешный бизнес, помогая людям
            улучшить качество жизни через инновационные продукты для здоровья.
          </ScrollText>
        </div>
      </div>
      ...
      <div ref={block1Ref} className="relative z-20 min-h-screen px-4 py-16">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <h4 className="mb-6 text-3xl font-semibold text-gray-900 dark:text-white md:text-5xl">Гибкий доход</h4>
          <h5 className="mb-8 text-xl font-bold uppercase tracking-[0.2em] text-green-500">ФИНАНСОВАЯ СВОБОДА</h5>
          <ScrollText className="mx-auto max-w-5xl text-lg leading-relaxed">
            Зарабатывайте на продажах и развитии своей партнерской сети без ограничения по времени. Система
            вознаграждений 4Life позволяет получать до 64% от оборота, включая бонусы с рекомендаций и кешбэк 20% при
            покупках свыше 100 баллов жизни ежемесячно.
          </ScrollText>
        </div>
      </div>
      ...
      <div ref={block2Ref} className="relative z-20 min-h-screen px-4 py-16">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <h5 className="mb-8 text-xl font-bold uppercase tracking-[0.2em] text-green-600">ЭКСПЕРТИЗА</h5>
          <ScrollText className="mx-auto max-w-5xl text-lg leading-relaxed">
            Доступ к проверенной бизнес-модели, готовым инструментам и персональной поддержке на всех этапах.
            Научно-консультативный совет из врачей и иммунологов обеспечивает экспертную базу знаний для работы с
            клиентами.
          </ScrollText>
        </div>
      </div>
      ...
      <div ref={block3Ref} className="relative z-20 min-h-screen px-4 py-16">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <h5 className="mb-8 text-xl font-bold uppercase tracking-[0.2em] text-green-600">СТАБИЛЬНОСТЬ</h5>
          <ScrollText className="mx-auto max-w-5xl text-lg leading-relaxed">
            Стройте бизнес с крупной международной компанией, работающей в 50+ странах с 1998 года. 4Life обеспечивает
            стабильность, официальные выплаты и безупречную репутацию на рынке здоровья и wellness.
          </ScrollText>
        </div>
      </div>
      ...
      <div className="relative z-30 px-4 py-24 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <ScrollText className="mx-auto mb-12 max-w-3xl text-lg leading-relaxed">
            Присоединяйтесь к команде компетентных лидеров и получите персональную консультацию по развитию бизнеса с
            4Life. Первый шаг к финансовой независимости начинается здесь.
          </ScrollText>
