...
const Portal = memo(
  forwardRef<HTMLDivElement, PortalProps>(
    ({ tier, palette, onChapter }, forwardedRef) => {
      ...
      const y = useTransform(
        scrollYProgress,
        [0, 0.45],
        inView ? ["0%", tier !== "low" ? "-18%" : "0%"] : ["0%", "0%"],
      );
      const scale = useTransform(
        scrollYProgress,
        [0, 0.45],
        inView ? [1, tier !== "low" ? 0.88 : 1] : [1, 1],
      );
        ...
        <div ref={forwardedRef}>
          ...
          >
            ...
            >
              ...
              {/* Animated underline */}
              <div
                className="mt-8 h-px w-full max-w-[60vw] overflow-hidden"
                style={{ background: palette.overlay10 }}
              >
                <motion.div
                  className="h-full"
                  style={{ width: lineW, background: palette.gold }}
                />
              </div>
              ...
              <motion.p
                ...
                className="mt-10 font-light text-center max-w-md"
                style={{
