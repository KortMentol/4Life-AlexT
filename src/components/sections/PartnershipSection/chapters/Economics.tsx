...
const ArcCounter = memo(({ tier, palette }: { tier: PerformanceTier; palette: Palette }) => {
  ...
  return (
    <div ref={ref} className="relative flex items-center justify-center" style={{ width: 280, height: 280 }}>
      <svg width="280" height="280" viewBox="0 0 280 280" className="-rotate-[135deg]" aria-hidden="true">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="mt-2 text-xs uppercase tracking-[0.3em]" style={{ color: palette.gold }}>
          твой доход
        </span>
      </div>
    </div>
...
const ECON_FACTS = [
  ["До 64%", "с каждой розничной продажи"],
  ["Residual", "доход от команды"],
  ["100%", "прозрачность выплат"],
  ["0₽", "скрытых сборов"],
] as const;
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <div>
              <ClipLine tier={tier} delay={0}>
                <h2
                  className="font-extralight leading-tight mb-6"
                  style={{
                ...
                >
                  С каждой продажи —<br />
                  <span style={{ color: palette.gold }}>тебе.</span>
                </h2>
              </ClipLine>
              ...
              >
                Прозрачная математика без скрытых сборов. До 64% маржи с розничной продажи. Плюс — остаточный доход от
                команды, которую ты строишь. Не разовая выплата — актив.
              </motion.p>
              ...
              <div className="grid grid-cols-2 gap-6 pt-10" style={{ borderTop: `1px solid ${palette.overlay10}` }}>
                {ECON_FACTS.map(([v, l], i) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] uppercase tracking-[0.22em]" style={{ color: palette.overlay40 }}>
                      {l}
                    </span>
                  </motion.div>
                ))}
