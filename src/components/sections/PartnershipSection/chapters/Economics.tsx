...
const ArcCounter = memo(
  ({ tier, palette }: { tier: PerformanceTier; palette: Palette }) => {
...
const Economics = memo(
  forwardRef<HTMLElement, EconomicsProps>(
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
              ...
              <div>
                ...
                >
                  Партнёр покупает продукцию по специальной цене и рекомендует
                  её по розничной. Разница остаётся вам. Плюс вы получаете
                  процент от покупок людей, которых пригласили в команду. Доход
                  растёт вместе с развитием структуры.
                </motion.p>
