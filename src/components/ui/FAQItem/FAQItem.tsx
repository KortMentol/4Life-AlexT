  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3
            className={`text-lg md:text-xl font-semibold pr-6 transition-colors duration-300 ${
              theme === "dark"
          ...
          >
            <div className="relative w-5 h-5">
              <div
                className={`absolute inset-0 border transform rotate-45 ${
              ...
              />
              <div
                className={`absolute top-0 left-1/2 w-px h-1 -translate-x-1/2 ${
                  theme === "dark" ? "bg-cyan-400/60" : "bg-blue-500/60"
                }`}
              />
              <div
                className={`absolute bottom-0 left-1/2 w-px h-1 -translate-x-1/2 ${
                  theme === "dark" ? "bg-cyan-400/60" : "bg-blue-500/60"
                }`}
              />
            </div>
