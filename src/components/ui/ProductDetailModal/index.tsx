...
// ─── Spring configs ───────────────────────────────────────────────────────────
const SPRING_HIGH = { type: "spring" as const, stiffness: 380, damping: 40, mass: 0.8 };
const SPRING_LOW = { type: "tween" as const, duration: 0.28, ease: [0.22, 1, 0.36, 1] as const };
...
const DesktopLayout: React.FC<DesktopLayoutProps> = ({
  ...
  <>
    ...
    <div style={{ display: "flex", flex: 1, minHeight: 0, padding: 24, gap: 24 }}>
      ...
      {/* Content */}
      <div
        style={{ flex: 1, minWidth: 0, overflowY: "auto", overscrollBehavior: "contain" }}
