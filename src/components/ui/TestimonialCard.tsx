...
const TestimonialCard = ({ image, name, title, quote, delay = 0 }: TestimonialCardProps) => {
  return (
    <motion.div
      className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 flex flex-col items-center text-center border border-white/20 dark:border-gray-700/50 hover:border-white/40 dark:hover:border-gray-600/70"
