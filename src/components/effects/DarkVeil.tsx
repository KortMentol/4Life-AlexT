  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (gl_objects) {
        ...
        // ИСПРАВЛЕНИЕ УТЕЧКИ: Безупречное освобождение памяти GPU при размонтировании
        try {
          const gl = gl_objects.renderer.gl;
          gl_objects.mesh.geometry.remove();
          gl.deleteProgram(gl_objects.program.program);
